...
{
	// If LeftClick is pressed down
    if (button==GLUT_LEFT_BUTTON && state == GLUT_DOWN) {
    	// If Shift is pressed when LeftClick is pressed
...
*   Better Menu
*   a) Deleting objects 
*   NOTE: Previous object does not properly get selected after object is deleted
*   since object is not actually deleted.
*   Duplicating deleted object duplicates an invisible object
*/  
...
*/
    ...
    glUniform4fv(glGetUniformLocation(shaderProgram, "LightPosition2"), 1, lightPosition2); //(Part I)
    CheckError();

    glUniform3fv(glGetUniformLocation(shaderProgram, "LightColor"), 1, lightObj1.rgb);
    CheckError();

    glUniform3fv(glGetUniformLocation(shaderProgram, "LightColor2"), 1, lightObj2.rgb); //(Part I)
    CheckError();
    ...
    */
    ...
    glUniform1f(glGetUniformLocation(shaderProgram, "LightBrightness2"), lightObj2.brightness); // (Part I)
    CheckError();
...
/*  Part J
*   Better Menu
*   c) Adding a spot light to the scene
*       with changeable illumination direction
*/ 
...
static void makeMenu()
{
    ...
    */
    ...
    glutAddMenuEntry("Remove object", 42);
...
void reshape( int width, int height )
{
    ...
    /*	Part D
    *	Fixed reshape callback for more "close up" views of objects without clipping
    *	By adjusting nearDist variable
    */
    ...
    */
    ...
    /*	Part E
    *	Fixing resizing of window to allow all objects that are visible when the window
    *	is square, to also be visible when the window is stretched or shortened horizontally
    */
